...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"王聪%ld", indexPath.row];
    // Configure the cell...
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UINavigationController *nav = (UINavigationController *)hou.centerVC;
    HomePageViewController *homePage = [nav.childViewControllers firstObject];
    homePage.wordLabel.text = [NSString stringWithFormat:@"王聪%ld", indexPath.row];
