...
@interface EFAnimationViewController ()
...
//- (void)configViews {
//    
//    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"20141029132548_e5rLM.jpeg"]];
//    NSArray *dataArray = @[@"1.00.jpg", @"1.01.jpg", @"1.02.jpg", @"1.03.jpg", @"1.04.jpg"];
//    NSArray *titleArray = @[@"热门榜", @"好评榜", @"下载榜", @"搜索榜", @"幻影"];
