...
-(void)setupView {
	...
	[self setBackgroundColor:[UIColor colorWithRed: 254/255.0  green:255/255.0  blue:239/255.0 alpha:1.0]];
    //[self setBackgroundColor:[UIColor whiteColor]];

	// Set a corner radius
	[self.layer setCornerRadius:1.0f];
	[self.layer setBorderWidth:1.5f];
	[self.layer setBorderColor:[ UIColor colorWithRed: 200/255.0  green: 148/255.0 blue: 62/255.0 alpha: 1.0].CGColor];
    //[self.layer setBorderColor:[ UIColor whiteColor].CGColor];

	[self setClipsToBounds:YES];
	
	// Set the font
	tickerFont = [UIFont systemFontOfSize:XRF(25.0)];
    ...
    [tickerLabel setTextColor:[UIColor grayColor]];
